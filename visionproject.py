...
def av_pix(img, circles, size):
    ...
    for coords in circles[0, :]:
        col = np.mean(img[coords[1] - size:coords[1] +
                      size, coords[0]-size:coords[0]+size])
...
# shows coordinates of circles
print(circles)

# draws the circles onto our image
# rounds the coordinates into integers
...
for i in circles[0, :]:
    ...
    cv2.circle(original_image, (i[0], i[1]), 2, (0, 0, 225), 3)
    # creating the count of the coins0
